...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cart.aspx.cs" Inherits="_cart" %>
            ...
            <main class="_70_m fl_lt relative">
                ...
                <div class="p_l clearfix">
                    ...
                    <div class="_50_m txt_xs">
                        <span class="_50_s input_area m_m_left"><input name="voucher" type="text" style="width:100%"/></span>
                        <input name="update" type="button" class="_33_s m_m_left button_sd round_sd inline_block" value="UPDATE" style="background:rgb(255,187,0)" />
                    </div>
